...
#------------------------------
    ...
    clawdata.lower[0] = -50e3         # xlower
    clawdata.upper[0] = 50e3        # xupper
    clawdata.lower[1] = -50e3         # ylower
    clawdata.upper[1] = 50e3        # yupper
    ...
    regions.append([1, 6, 0., 1e9, -1e6, 1e6, -1e6, 1e6])   # whole domain
    #regions.append([2, 3, 0., 50., -10e3, 10e3, -10e3, 10e3])   # near origin
...
#-------------------
    ...
    topofiles.append([1, 'flat_4000.tt1'])
